        ...
        <DndContext onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
            <div className="flex flex-col h-screen max-h-[900px] gap-4 p-6 bg-slate-50/50 dark:bg-slate-950/50 animate-in fade-in duration-500">
                ...
                <div className="flex justify-between items-center mb-2">
                    <Tabs value={selectedGroup} onValueChange={setSelectedGroup} className="w-[400px]">
                        <TabsList className="bg-white dark:bg-slate-900 border shadow-sm">
                            {groups.map(g => (
                                <TabsTrigger key={g} value={g} className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700">
                                    {g}
                                </TabsTrigger>
                            ))}
                        </TabsList>
